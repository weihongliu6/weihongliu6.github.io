...
import { renderReader, bindReader } from './reader.js?v=phase2-20260925';
...
try{
  const response=await fetch('data/books.json?v=phase2-20260925');if(!response.ok) throw Error('书架资料加载失败');
